/**
 * 导入商品数据到 Cloudflare Workers API
...
const products = [
  ...
  {
    name: 'Flexible Container Bag (Usable)',
...
async function importProducts() {
  console.log(`开始导入 ${products.length} 个商品到 ${API_URL}...\n`);
  ...
  for (const product of products) {
    try {
      ...
      console.error(`✗ 错误: ${product.nameJa} - ${error.message}`);
      failCount++;
    }
  }
